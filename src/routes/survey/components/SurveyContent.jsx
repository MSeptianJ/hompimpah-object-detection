...
const SurveyContent = () => {
	return (
		<>
			...
			<div className="group mx-auto rounded-sm bg-accentColor text-backColor shadow-lg transition-colors duration-300 hover:border hover:border-accentColor hover:bg-primaryColor">
				<a
